        ...
        >
          ...
          <div className="relative z-160 flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar bg-transparent">
            <div className="max-w-325 mx-auto px-8 pt-10 pb-1">
              ...
              <section className="mt-40 space-y-16">
                ...
                <div className="grid grid-cols-1 gap-10">
                  {hero.skills.map((skill, index) => (
                    <div key={index} className="flex flex-col md:flex-row gap-8 lg:gap-12 p-8 lg:p-10 rounded-[2.5rem] bg-zinc-900/10 border border-zinc-800/40 backdrop-blur-md group hover:border-zinc-500/30 transition-all">
              ...
              <footer className="mt-20 pb-10 text-center border-t border-zinc-900/50 pt-10">
