            ...
            <div className="max-w-325 mx-auto px-8 pt-10 pb-32 bg-transparent">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start bg-transparent">
                ...
                <div className="lg:col-span-7 flex flex-col pt-4 bg-transparent">
                  ...
                  {/* STATISTICS - Updated with Lucide Mappings */}
                  <section>
...
function StatBox({
  label,
  value,
  icon: Icon, // Rename it to Icon (capitalized) to use as a component
}: {
  label: string;
  value: string;
  icon: LucideIcon; // This ensures only Lucide icons can be passed
}) {
  return (
