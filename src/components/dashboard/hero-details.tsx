              ...
              <section className="mt-32 space-y-10">
                <Tabs defaultValue="abilities" className="w-full">
                  <div className="border-b border-zinc-900 pb-2">
                    <TabsList className="bg-transparent h-auto p-0 flex flex-wrap gap-6 justify-start">
                      <TabsTrigger 
                        value="abilities" 
                        className="data-[state=active]:bg-transparent data-[state=active]:text-white data-[state=active]:border-white data-[state=active]:shadow-none bg-transparent border-transparent border-b-2 rounded-none px-0 pb-3 text-2xl font-black text-zinc-500 uppercase italic tracking-tighter"
                      >
                        Abilities
                      </TabsTrigger>
                  ...
                  <div className="pt-10">
                    <TabsContent value="abilities" className="space-y-10 mt-0 outline-none">
