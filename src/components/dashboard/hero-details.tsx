        ...
        >
          ...
          <nav className="relative z-[170] shrink-0 px-8 py-6 bg-transparent">
            <Button
              variant="ghost"
              onClick={onClose}
              className="text-zinc-400 hover:text-white hover:bg-transparent transition-all p-0 group"
            >
                ...
                <div className="lg:col-span-7 flex flex-col pt-4">
                  <header className="mb-10">
                    <div className="flex items-center gap-6 mb-6">
                      ...
                      {/* FIX 2: ROLES ARE BIGGER (Icon size w-5/h-5 and text sizes increased) */}
                          ...
                          <div key={role} className="flex items-center gap-2">
                            {ROLE_ICONS[role.toLowerCase()] && (
                              <img
                                ...
                                alt={role}
                                className="w-6 h-6 object-contain brightness-125" // Increased from w-4 to w-6
                              />
                            )}
                            <span
                  ...
                  {hero.skills.map((skill, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1 space-y-6">
                        ...
                        <p className="text-base lg:text-lg leading-[1.65] text-zinc-200 max-w-4xl font-normal">
                          {skill.description}
                        </p>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-6 pt-4">
                            {Object.entries(skill.attributes).map(
                              ([key, values]) => (
                                <div
                                  key={key}
                                  className="space-y-1.5 border-l-2 border-zinc-700 pl-4"
                                >
...
/**
 * FIX 3: RATING ROW LABELS
 * Changed text-zinc-400 to text-zinc-300 for higher visibility.
 **/
...
/**
 * FIX 4: STAT BOX LABELS
 * Changed text-zinc-500 to text-zinc-300 for higher visibility.
 **/
const StatBox = memo(
  ({
    label,
    ...
    return (
      <div className="flex items-start gap-5 group">
        <div className="text-white mt-1 shrink-0 opacity-100">
